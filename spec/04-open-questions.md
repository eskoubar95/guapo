...
- **Adyen recurring capabilities**: confirm tokenization/mandates + at least one successful renewal simulation in staging.
- **Adyen method availability**: confirm MobilePay, Klarna, and wallets are enabled and functional in DK (staging).
